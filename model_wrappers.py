# Implementation of model_wrappers partly taken and modified from
# https://github.com/White-Link/UnsupervisedScalableRepresentationLearningTimeSeries/blob/master/scikit_wrappers.py,
# originally created
